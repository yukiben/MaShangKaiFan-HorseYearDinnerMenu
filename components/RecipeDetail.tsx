    ...
    <div className="flex flex-col min-h-screen pb-32 bg-background-dark">
      ...
      <main className="p-6 space-y-8">
        <section className="bg-primary/5 p-6 rounded-3xl border border-primary/20">
            <h3 className="text-3xl font-black text-white font-calligraphy mb-2">{dish.name}</h3>
            <div className="flex items-center gap-2">
              <span className="bg-primary text-white text-[9px] px-1.5 py-0.5 rounded font-bold uppercase tracking-tighter">寓意</span>
              <p className="text-gold text-xs font-bold tracking-widest">{dish.meaning}</p>
            </div>
        </section>
